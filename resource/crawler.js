            ...
            if ('itemType' in item) {
                ...
                if (item.valueRender) {
                    try {
                        ...
                        let res = render.call({ ...item, ctx: { __config__, __result__, curSectionResult: data } }, result, node);
                        if (res !== undefined) {
                            data[item.id] = res;
                        }
                    }
        ...
        if ('itemType' in item) {
            ...
            if (item.valueRender) {
                try {
                    ...
                    let res = render.call({ ...item, ctx: { __config__, __result__, curSectionResult: dataObject } }, result, node);
                    if (res !== undefined) {
